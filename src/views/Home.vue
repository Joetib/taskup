...
<header class="masthead" style="background: linear-gradient(rgb(119,105,255) 19%, white), #000000;">
        <div class="container">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <h2 class="text-uppercase section-heading">It’s more than work. <br>It’s a way of working together.<br></h2>
                    <h3 class="text-muted section-subheading">Start with a Task Up board, lists, and cards. Customize and expand with more features as your teamwork grows. <br>Manage projects, organize tasks, and build team spirit—all in one place.<br></h3>
                </div>
            </div>
            <div class="row text-center">
                <div class="col-md-4"><span class="fa-stack fa-4x"><i class="fa fa-circle fa-stack-2x text-primary"></i><i class="fa fa-dashboard fa-stack-1x fa-inverse"></i></span>
                    <h4 class="section-heading">DASHBOARD</h4>
                    <p class="text-muted">This basically contains everything you need.<br>Starting from current works to chats and<br>deadlines.</p>
                </div>
                <div class="col-md-4"><span class="fa-stack fa-4x"><i class="fa fa-circle fa-stack-2x text-primary"></i><i class="fa fa-wechat fa-stack-1x fa-inverse"></i></span>
                    <h4 class="section-heading">CHATS</h4>
                    <p class="text-muted">We just don't keep track of your work,<br>we give you chance to interract.</p>
                </div>
                <div class="col-md-4"><span class="fa-stack fa-4x"><i class="fa fa-circle fa-stack-2x text-primary"></i><i class="fa fa-bar-chart fa-stack-1x fa-inverse"></i></span>
                    ...
                    <p class="text-muted">Are you worried about deadlines?&nbsp;<br>We are here for you.</p>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    ...
                    <h3 class="text-muted section-subheading">We are always available</h3>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
