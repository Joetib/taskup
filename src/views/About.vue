  ...
  <div class="about">
      ...
      <section>
        <div class="container text-center animate_animated animated_bounce py-5">
            <h1 style="color: #2e2d2de0;margin-top:35px">Our Approach</h1>
            <p>Encouraging Agile practices with a focus on Scrum architecture</p> 
        </div>
    </section>
    ...
    <section>
        <div class="container text-center animate_animated animated_bounce py-5" >
            It reminds us of the early traction that Dropbox…and other apps up there had that have grabbed individuals and caused them to start using it and bring it to work and convince teams and colleagues to use it and it’s gradually taken over organizations,” said Index Partner Neil Rimer</div>
    </section>

    <section>
        <div class="container text-center animate_animated animated_bounce py-5" >
           The visual organizing software has amassed some 4.6 million registered users — now with one million monthly actives — turning their projects, whether household to-do lists or corporate realignment plans, into visual boards using its cloud-based software.<br><br>
...
<style>
    ...
    .about{
        font-size: 1.2em;
        background-image: linear-gradient(rgba(216, 190, 190, 0), rgba(45, 110, 126, 0.377));
    }
